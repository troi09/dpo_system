...
export default function StudentNDARequest() {
  const navigate = useNavigate();

  // NDA form fields (can edit later)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("NDA request submitted!");
      navigate("/student");
    } catch (err) {
      alert(err.response?.data?.message || "Failed to submit NDA request");
    }
  };
